...
const initialState = {
    restaurants: [],
    usersRestaurant: null,  // Fixed double colon typo
    restaurant: null,
    loading: false,
    error: null,
    events: [],
...
case actionTypes.GET_RESTAURANTS_EVENTS_SUCCESS:  // Fixed typo: RESTAIRANTS → RESTAURANTS
    return {
        ...state,
        loading: false,
...
case actionTypes.CREATE_CATEGORY_FAILURE:
    case actionTypes.GET_RESTAURANTS_CATEGORY_FAILURE:  // Fixed typo: FAILLURE → FAILURE
    return {
        ...state,
        loading: false,
