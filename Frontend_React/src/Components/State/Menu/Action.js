...
import { CREATE_MENU_ITEM_FAILURE, CREATE_MENU_ITEM_REQUEST, CREATE_MENU_ITEM_SUCCESS, GET_MENU_ITEMS_BY_RESTAURANT_ID_FAILURE, GET_MENU_ITEMS_BY_RESTAURANT_ID_REQUEST, GET_MENU_ITEMS_BY_RESTAURANT_ID_SUCCESS } from "./ActionTypes";
...
//         try {
//             const { data } = await api.get(
//                 `/api/food/${reqData.menuItemId}/ingredients`,
//                 {
//                     headers: {
//                         Authorization: `Bearer ${reqData.jwt}`,
//                     },
    ...
    return async (dispatch) => {
        ...
        try {
            const { data } = await api.put(
                `/api/admin/food/${foodId}/availability`,
                {}, // Empty body for toggle-style request
                {
                    headers: {
                        Authorization: `Bearer ${jwt}`,
                    },
